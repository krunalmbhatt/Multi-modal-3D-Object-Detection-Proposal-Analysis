...
CHECKPOINT_FILE="/home/kmbhatt/home/dr_sem4/gits/MEFormer/work_dirs/meformer_voxel0075_vov_1600x640_cbgs/20250427-173924/epoch_6.pth"
...
NMS_THR=0.15
MAX_NUM=200
OUTPUT_DIR="./test_results/$(basename $CONFIG_FILE .py)_nms${NMS_THR}_max${MAX_NUM}"
